...
public final class Intents {
  ...
  public static final class Scan {
     ...
     * useful to limit scanning to certain formats. Use {@link Intent#putExtra(String, String)} with
     * one of the values below.
     *
     * Setting this is effectively shorthand for setting explicit formats with {@link #FORMATS}. It
     * is overridden by that setting.
     */
